...
def universele_data():
    ...
    c = conn.cursor()
    gewassen = c.execute('SELECT * FROM stikstof_gewassen_normen').fetchall()
    fosfaatnormen = c.execute('SELECT * FROM fosfaat_normen').fetchall()
    derogatienormen = c.execute('SELECT * FROM derogatie_normen').fetchall()
    werkingscoefs = c.execute('SELECT * FROM stikstof_werkingscoefficient_dierlijk').fetchall()
    universele_meststoffen = c.execute('SELECT * FROM universal_fertilizers').fetchall()
    conn.close()
    return render_template('universele_data/universele_data.html',
        gewassen=gewassen,
...
def delete_gewas(id):
    ...
    conn = db.get_connection()
    c = conn.cursor()
    c.execute('DELETE FROM stikstof_gewassen_normen WHERE id=?', (id,))
    conn.commit()
    conn.close()
    return redirect(url_for('universele_data.universele_data'))
...
def delete_gewas_year():
    ...
    conn = db.get_connection()
    c = conn.cursor()
    c.execute('DELETE FROM stikstof_gewassen_normen WHERE jaar=?', (jaar,))
    conn.commit()
    conn.close()
    return redirect(url_for('universele_data.universele_data'))
...
def delete_fosfaat(id):
    ...
    conn = db.get_connection()
    c = conn.cursor()
    c.execute('DELETE FROM fosfaat_normen WHERE id=?', (id,))
    conn.commit()
    conn.close()
    return redirect(url_for('universele_data.universele_data'))
...
def delete_fosfaat_year():
    ...
    conn = db.get_connection()
    c = conn.cursor()
    c.execute('DELETE FROM fosfaat_normen WHERE jaar=?', (jaar,))
    conn.commit()
    conn.close()
    return redirect(url_for('universele_data.universele_data'))
...
def delete_derogatie(id):
    ...
    conn = db.get_connection()
    c = conn.cursor()
    c.execute('DELETE FROM derogatie_normen WHERE id=?', (id,))
    conn.commit()
    conn.close()
    return redirect(url_for('universele_data.universele_data'))
...
def delete_derogatie_year():
    ...
    conn = db.get_connection()
    c = conn.cursor()
    c.execute('DELETE FROM derogatie_normen WHERE jaar=?', (jaar,))
    conn.commit()
    conn.close()
    return redirect(url_for('universele_data.universele_data'))
...
def delete_werkingscoefficient(id):
    ...
    conn = db.get_connection()
    c = conn.cursor()
    c.execute('DELETE FROM stikstof_werkingscoefficient_dierlijk WHERE id=?', (id,))
    conn.commit()
    conn.close()
    return redirect(url_for('universele_data.universele_data'))
...
def delete_werkingscoefficient_year():
    ...
    conn = db.get_connection()
    c = conn.cursor()
    c.execute('DELETE FROM stikstof_werkingscoefficient_dierlijk WHERE jaar=?', (jaar,))
    conn.commit()
    conn.close()
    return redirect(url_for('universele_data.universele_data'))
...
def delete_universal_fertilizer(id):
    ...
    conn = db.get_connection()
    c = conn.cursor()
    c.execute('DELETE FROM universal_fertilizers WHERE id=?', (id,))
    conn.commit()
    conn.close()
    return redirect(url_for('universele_data.universele_data'))
